...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    try {
      ...
      // All transactions are for Bhujji Akka - organized chronologically
      const bhujjiAkkaTransactions = [
        ...
        },
        {
          ...
          description: 'Given to Bhujji Akka (4448 + 3000)',
          payment_method: 'Cash',
          is_settled: false,
          apply_interest: true,
          interest_type: 'simple',
        ...
        },
        {
          ...
          description: 'Given to Bhujji Akka - Raju',
          payment_method: 'Cash',
          is_settled: false,
          apply_interest: true,
          interest_type: 'simple',
        ...
        },
        {
          ...
          description: 'Given to Bhujji Akka - Raja bullet bike',
          payment_method: 'Cash',
          is_settled: false,
          apply_interest: true,
          interest_type: 'simple',
        ...
        },
        {
          ...
          is_money_received: false,
          transaction_date: '2025-06-07',
          description: 'Given to Bhujji Akka - Bullet Sevika Raja',
          payment_method: 'Cash',
          is_settled: false,
          apply_interest: true,
          interest_type: 'simple',
        ...
        },
        {
          ...
          description: 'Given to Bhujji Akka - Glow plod Raja',
          payment_method: 'Cash',
          is_settled: false,
          apply_interest: true,
          interest_type: 'simple',
        ...
        },
        {
          ...
          description: 'Given to Bhujji Akka - care Raja',
          payment_method: 'Cash',
          is_settled: false,
          apply_interest: true,
          interest_type: 'simple',
        ...
        },
        {
          ...
          description: 'Given to Bhujji Akka - dried',
          payment_method: 'Cash',
          is_settled: false,
          apply_interest: true,
          interest_type: 'simple',
        ...
        },
        {
          ...
          is_money_received: false,
          transaction_date: '2025-08-10',
          description: 'Given to Bhujji Akka - Jeej keru',
          payment_method: 'Cash',
          is_settled: false,
          apply_interest: true,
          interest_type: 'simple',
        ...
        },
        {
          ...
          description: 'Given to Bhujji Akka - user',
          payment_method: 'Cash',
          is_settled: false,
          apply_interest: true,
          interest_type: 'simple',
        ...
        },
        {
          ...
          description: 'Given to Bhujji Akka - gold withdraw',
          payment_method: 'Cash',
          is_settled: false,
          apply_interest: true,
          interest_type: 'simple',
        ...
        },
        {
          ...
          description: 'Received from Bhujji Akka - Gold return',
          payment_method: 'Cash',
          is_settled: false,
          apply_interest: true,
          interest_type: 'simple',
                ...
                },
        {
          ...
          description: 'Given to Bhujji Akka - Raja hostel fee',
          payment_method: 'Cash',
          is_settled: false,
          apply_interest: true,
          interest_type: 'simple',
        ...
        },
        {
          ...
          description: 'Given to Bhujji Akka - Raja hospital',
          payment_method: 'Cash',
          is_settled: false,
          apply_interest: true,
          interest_type: 'simple',
