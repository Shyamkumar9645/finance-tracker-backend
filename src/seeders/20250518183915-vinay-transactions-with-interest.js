...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    try {
      ...
      // All transactions for Vinay - properly ordered chronologically
      const vinayTransactions = [
        ...
        // Additional 2025 transactions from new image
        {
          user_id: 1,
          person_id: personId,
          amount: 5000.00,
          ...
          description: 'Given to Vinay - Vineeth',
          payment_method: 'Cash',
          is_settled: false,
          apply_interest: true,
          interest_type: 'simple',
        ...
        },
        {
          ...
          is_money_received: false,
          transaction_date: '2025-06-01',
          description: 'Given to Vinay - JECTC',
          payment_method: 'Cash',
          is_settled: false,
          apply_interest: true,
          interest_type: 'simple',
        ...
        },
        {
          ...
          description: 'Given to Vinay - Vineeth fee',
          payment_method: 'Cash',
          is_settled: false,
          apply_interest: true,
          interest_type: 'simple',
        ...
        },
        {
          ...
          description: 'Received from Vinay - Vineeth',
          payment_method: 'Cash',
          is_settled: false,
          apply_interest: true,
          interest_type: 'simple',
        ...
        // Additional 2024 transactions from new image (chronologically placed)
        {
          user_id: 1,
          person_id: personId,
          amount: 500.00,
